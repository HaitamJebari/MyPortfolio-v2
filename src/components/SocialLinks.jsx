...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/haitam-jebari-6b0280254/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@haitameljebari",
    icon: Instagram,
    url: "https://www.instagram.com/haitameljebari/?next=%2F",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@haitam jebari",
    icon: Github,
    url: "https://github.com/HaitamJebari",
    color: "#ffffff",
